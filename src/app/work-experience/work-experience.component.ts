  ...
  workExpList: WorkExperience[] = [
    {
      ...
      description: [
        ...
        'Created reusable components using Angular to boost-up application performance by 25%.',
        ...
        'Developed reusable components and lazy loading to enhance app performance. ',
